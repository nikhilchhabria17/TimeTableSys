                    ...
                    <c:forEach var="col" items="${entry.value}">                      
                        <td><c:out value="${col}"></c:out></td>                    
                         ...
                         <c:choose>
                          ...
                          <td>
                               <a href="edit?columnname=${column}&${column}=<c:out value='${entry.value.get(0)}' />" class="btn btn-outline-primary">Edit</a>
                        </td>
                        <td>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                                <a href="/TimeTable-DSS/${tablename}/delete?columnname=${column}&${column}=<c:out value='${entry.value.get(0)}' />" class="btn btn-outline-primary">Delete</a>                     
                        </td>
                            </c:when>    
                            <c:otherwise>
